...
from azure.cli.command_modules.role._msgraph import GraphError
    ...
    def test_role_assignment_create_using_principal_type(self, resource_group):
        ...
        def _test_role_assignment(assignee_object_id, assignee_principal_type=None, graph_call_fails=False):
            ...
            if assignee_principal_type:
                # No graph call
                with mock.patch('azure.cli.command_modules.role._msgraph._graph_client.GraphClient.directory_object_get_by_ids') \
                ...
                if graph_call_fails:
                    ...
                    with mock.patch(
                            'azure.cli.command_modules.role._msgraph._graph_client.GraphClient.directory_object_get_by_ids',
