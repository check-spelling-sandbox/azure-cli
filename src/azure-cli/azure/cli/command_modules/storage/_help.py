...
examples:
  ...
  - name: Sync a directory to a container with azcopy options pass-through (in this case capping the upload bandwidth to 20 MBit/s).
...
long-summary: 'BREAKING CHANGE: Snapshot cannot be deleted by default and we have added a new parameter to use if you want to include snapshots for delete operation.'
examples:
