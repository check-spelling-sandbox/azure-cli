...
class List(AAZCommand):
    ...
    class RestorePointCollectionsList(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            additional_unattended_content = cls._schema_on_200.value.Element.properties.restore_points.Element.properties.source_metadata.os_profile.windows_configuration.additional_unattended_content
            additional_unattended_content.Element = AAZObjectType()

            _element = cls._schema_on_200.value.Element.properties.restore_points.Element.properties.source_metadata.os_profile.windows_configuration.additional_unattended_content.Element
