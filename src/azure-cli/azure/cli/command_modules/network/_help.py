...
examples:
  ...
  - name: Create a basic load balancer on a subnet of a preexisting virtual network. The subnet can be in arbitrary resource group or subscription by providing the ID of the subnet.
    text: >
