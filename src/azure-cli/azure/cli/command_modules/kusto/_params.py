...
def load_arguments(self, _):
    ...
    time_format_explanation = 'Duration in ISO8601 format (for example, 100 days would be P100D).'
    ...
    with self.argument_context('kusto database') as c:
        ...
        c.argument('soft_delete_period', help='Amount of time that data should be kept so it is available to query. ' + time_format_explanation)
        c.argument('hot_cache_period', help='Amount of time that data should be kept in cache.' + time_format_explanation)
