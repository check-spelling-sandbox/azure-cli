...
def load_arguments(self, _):    # pylint: disable=too-many-statements
    ...
    with self.argument_context('eventgrid partner namespace event-channel') as c:
        ...
        c.argument('event_channel_name', arg_type=event_channel_name_type, options_list=['--name', '-n'], id_part='name', completer=get_resource_name_completion_list('Microsoft.EventGrid/partnernamespaces/eventchannels'))
